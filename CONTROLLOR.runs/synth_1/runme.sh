...
HD_PWD=C:/FPGAPrj/VIVADO/CONTROLLOR/CONTROLLOR.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log CONTROLLOR_VHDL.vds -m64 -mode batch -messageDb vivado.pb -notrace -source CONTROLLOR_VHDL.tcl
