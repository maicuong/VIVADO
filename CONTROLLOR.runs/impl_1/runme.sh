...
HD_PWD=C:/FPGAPrj/VIVADO/CONTROLLOR/CONTROLLOR.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log CONTROLLOR_VHDL.vdi -applog -m64 -messageDb vivado.pb -mode batch -source CONTROLLOR_VHDL.tcl -notrace
